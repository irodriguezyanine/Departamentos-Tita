...
Ubicado en el Arriendos Puerto Pacífico, combina la tranquilidad residencial con la proximidad a Marina Arauco, playa Las Salinas y todos los servicios. Un refugio de confort y elegancia en Viña del Mar.`,
    ...
    imagenes: [
      { url: `${BASE}/13d-torre-cabo-hornos/foto-8.png`, orden: 0, alt: "Vista panorámica al océano y playa" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-1.png`, orden: 1, alt: "Salón-comedor con alfombra verde" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-2.png`, orden: 2, alt: "Vista al mar desde el living" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-3.png`, orden: 3, alt: "Dormitorio con literas y cama principal" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-4.png`, orden: 4, alt: "Dormitorio con ventanal y vista" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-5.png`, orden: 5, alt: "Cocina equipada" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-6.png`, orden: 6, alt: "Área de lavandería" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-7.png`, orden: 7, alt: "Logia con vista a la ciudad" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-9.png`, orden: 8, alt: "Dormitorio con luz natural" },
      { url: `${BASE}/13d-torre-cabo-hornos/foto-10.png`, orden: 9, alt: "Vista a la playa y costa" },
    ],
  },
  {
